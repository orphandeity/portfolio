    ...
    <main className="container">
      ...
      <div className="space-y-4">
        ...
        <p>
          ...
          these tools was a challenging but rewarding experience that helped me
          grow as an artist. They taught me to approach problem-solving
          programmatically and inspired me to explore innovative ways to combine
        ...
        <p>
          ...
          JavaScript and gradually built my skills in web development. It
          wasn&apos;t easy initially, but I enjoyed creating websites and
          applications that people could access worldwide.
        </p>
        <p>
